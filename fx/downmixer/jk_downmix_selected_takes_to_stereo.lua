-- @description Downmix Selected Takes To Stereo
-- @about Adds the Downmixer plugin to the selected takes and downmixes them to stereo
-- @author Julius Kukla
-- @version 0.0.0
-- @provide
--  jk_api/jk_api.lua
...
function Main()
	...
	jk_fx.RouteSelectedTakeOutputs(jk_fx.GetOutputChannelMapStereo(), true)
